...
DefaultGroupName=MT2
Compression=lzma2
SolidCompression=yes
OutputDir=.\
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=MT2 Installer
...
[Icons]
Name: "{group}\MT2"; Filename: "{app}\MT2.exe"
Name: "{group}\User guide"; Filename: "{app}\MT2_manual.pdf"
Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
Name: "{group}\Uninstall MT2"; Filename: "{app}\unins000.exe"
