...
public:
  ...
  void setup_inverse()
  {
    ...
    auto jac4_3 = 0;
    auto jac4_4 = 0 - (steady_state ? 0 : c035.get_gradient()) - r053.get_gradient();
  ...
  bool iterate() const
  {
    ...
    auto eq3 = dynamic_state[4] - dynamic_state[3];
    auto eq4 = -(steady_state ? 0 : c035.get_current(d2_, d4_)) - r053.get_current(s0_, d4_);
