...
public:
  ...
  {
    // update_steady_state
    c035.update_steady_state(1. / input_sampling_rate, dynamic_state[2], dynamic_state[0]);
    c034.update_steady_state(1. / input_sampling_rate, dynamic_state[3], dynamic_state[2]);
  ...
  void process_impl(gsl::index size) const override
  {
    for(gsl::index i = 0; i < size; ++i)
    {
      ...
      // Update state
      c035.update_state(dynamic_state[2], dynamic_state[0]);
      c034.update_state(dynamic_state[3], dynamic_state[2]);
  ...
  bool iterate() const
  {
    ...
    auto eq0 = -q010.ib() - r053.get_current(s0_, d0_) - (steady_state ? 0 : c035.get_current(d2_, d0_));
    auto eq1 = +q010.ib() + q010.ic() - r046.get_current(d2_, d1_) + r054.get_current(d1_, s1_);
    auto eq2 = +r046.get_current(d2_, d1_) + (steady_state ? 0 : c035.get_current(d2_, d0_))
             - (steady_state ? 0 : c034.get_current(d3_, d2_));
    auto eq3 = +r044.get_current(d3_, d4_) + (steady_state ? 0 : c034.get_current(d3_, d2_));
    auto eq4 = input_state[0] - dynamic_state[3];
    ...
    auto jac0_2 = 0 + (steady_state ? 0 : c035.get_gradient());
    auto jac0_3 = 0;
    auto jac0_4 = 0;
    ...
    auto jac1_2 = 0 + r046.get_gradient();
    auto jac1_3 = 0;
    auto jac1_4 = 0;
    auto jac2_0 = 0 + (steady_state ? 0 : c035.get_gradient());
    auto jac2_1 = 0 + r046.get_gradient();
    auto jac2_2
        = 0 - r046.get_gradient() - (steady_state ? 0 : c035.get_gradient()) - (steady_state ? 0 : c034.get_gradient());
    auto jac2_3 = 0 + (steady_state ? 0 : c034.get_gradient());
    auto jac2_4 = 0;
    auto jac3_0 = 0;
    auto jac3_1 = 0;
    auto jac3_2 = 0 + (steady_state ? 0 : c034.get_gradient());
    auto jac3_3 = 0 - r044.get_gradient() - (steady_state ? 0 : c034.get_gradient());
    auto jac3_4 = 0 + r044.get_gradient();
    auto jac4_0 = 0;
    auto jac4_1 = 0;
    auto jac4_2 = 0;
    auto jac4_3 = 0 + -1;
    auto jac4_4 = 0;
    auto det = (1 * jac0_0
                    * (1 * jac1_1 * (1 * jac2_2 * (-1 * jac3_4 * jac4_3))
                        + -1 * jac1_2 * (1 * jac2_1 * (-1 * jac3_4 * jac4_3)))
                + -1 * jac0_1
                      * (1 * jac1_0 * (1 * jac2_2 * (-1 * jac3_4 * jac4_3))
                          + -1 * jac1_2 * (1 * jac2_0 * (-1 * jac3_4 * jac4_3)))
                + 1 * jac0_2
                      * (1 * jac1_0 * (1 * jac2_1 * (-1 * jac3_4 * jac4_3))
                          + -1 * jac1_1 * (1 * jac2_0 * (-1 * jac3_4 * jac4_3))));
    auto invdet = 1 / det;
    auto com0_0
        = (1 * jac1_1 * (1 * jac2_2 * (-1 * jac3_4 * jac4_3)) + -1 * jac1_2 * (1 * jac2_1 * (-1 * jac3_4 * jac4_3)));
    auto com1_0
        = -1
        * (1 * jac1_0 * (1 * jac2_2 * (-1 * jac3_4 * jac4_3)) + -1 * jac1_2 * (1 * jac2_0 * (-1 * jac3_4 * jac4_3)));
    auto com2_0
        = (1 * jac1_0 * (1 * jac2_1 * (-1 * jac3_4 * jac4_3)) + -1 * jac1_1 * (1 * jac2_0 * (-1 * jac3_4 * jac4_3)));
    auto com3_0 = -1 * 0;
    auto com4_0
        = (1 * jac1_0 * (1 * jac2_1 * (1 * jac3_2 * jac4_3)) + -1 * jac1_1 * (1 * jac2_0 * (1 * jac3_2 * jac4_3)));
    auto com0_1
        = -1
        * (1 * jac0_1 * (1 * jac2_2 * (-1 * jac3_4 * jac4_3)) + -1 * jac0_2 * (1 * jac2_1 * (-1 * jac3_4 * jac4_3)));
    auto com1_1
        = (1 * jac0_0 * (1 * jac2_2 * (-1 * jac3_4 * jac4_3)) + -1 * jac0_2 * (1 * jac2_0 * (-1 * jac3_4 * jac4_3)));
    auto com2_1
        = -1
        * (1 * jac0_0 * (1 * jac2_1 * (-1 * jac3_4 * jac4_3)) + -1 * jac0_1 * (1 * jac2_0 * (-1 * jac3_4 * jac4_3)));
    auto com3_1 = 0;
    auto com4_1
        = -1 * (1 * jac0_0 * (1 * jac2_1 * (1 * jac3_2 * jac4_3)) + -1 * jac0_1 * (1 * jac2_0 * (1 * jac3_2 * jac4_3)));
    auto com0_2
        = (1 * jac0_1 * (1 * jac1_2 * (-1 * jac3_4 * jac4_3)) + -1 * jac0_2 * (1 * jac1_1 * (-1 * jac3_4 * jac4_3)));
    auto com1_2
        = -1
        * (1 * jac0_0 * (1 * jac1_2 * (-1 * jac3_4 * jac4_3)) + -1 * jac0_2 * (1 * jac1_0 * (-1 * jac3_4 * jac4_3)));
    auto com2_2
        = (1 * jac0_0 * (1 * jac1_1 * (-1 * jac3_4 * jac4_3)) + -1 * jac0_1 * (1 * jac1_0 * (-1 * jac3_4 * jac4_3)));
    auto com3_2 = -1 * 0;
    auto com4_2
        = (1 * jac0_0 * (1 * jac1_1 * (1 * jac3_2 * jac4_3)) + -1 * jac0_1 * (1 * jac1_0 * (1 * jac3_2 * jac4_3)));
    auto com0_3 = -1 * 0;
    auto com1_3 = 0;
    auto com2_3 = -1 * 0;
    auto com3_3 = 0;
    auto com4_3 = -1
                * (1 * jac0_0 * (1 * jac1_1 * (1 * jac2_2 * jac4_3) + -1 * jac1_2 * (1 * jac2_1 * jac4_3))
                    + -1 * jac0_1 * (1 * jac1_0 * (1 * jac2_2 * jac4_3) + -1 * jac1_2 * (1 * jac2_0 * jac4_3))
                    + 1 * jac0_2 * (1 * jac1_0 * (1 * jac2_1 * jac4_3) + -1 * jac1_1 * (1 * jac2_0 * jac4_3)));
    auto com0_4
        = (1 * jac0_1 * (1 * jac1_2 * (1 * jac2_3 * jac3_4)) + -1 * jac0_2 * (1 * jac1_1 * (1 * jac2_3 * jac3_4)));
    auto com1_4
        = -1 * (1 * jac0_0 * (1 * jac1_2 * (1 * jac2_3 * jac3_4)) + -1 * jac0_2 * (1 * jac1_0 * (1 * jac2_3 * jac3_4)));
    auto com2_4
        = (1 * jac0_0 * (1 * jac1_1 * (1 * jac2_3 * jac3_4)) + -1 * jac0_1 * (1 * jac1_0 * (1 * jac2_3 * jac3_4)));
    auto com3_4 = -1
                * (1 * jac0_0 * (1 * jac1_1 * (1 * jac2_2 * jac3_4) + -1 * jac1_2 * (1 * jac2_1 * jac3_4))
                    + -1 * jac0_1 * (1 * jac1_0 * (1 * jac2_2 * jac3_4) + -1 * jac1_2 * (1 * jac2_0 * jac3_4))
                    + 1 * jac0_2 * (1 * jac1_0 * (1 * jac2_1 * jac3_4) + -1 * jac1_1 * (1 * jac2_0 * jac3_4)));
    auto com4_4
        = (1 * jac0_0
                * (1 * jac1_1 * (1 * jac2_2 * jac3_3 + -1 * jac2_3 * jac3_2) + -1 * jac1_2 * (1 * jac2_1 * jac3_3))
            + -1 * jac0_1
                  * (1 * jac1_0 * (1 * jac2_2 * jac3_3 + -1 * jac2_3 * jac3_2) + -1 * jac1_2 * (1 * jac2_0 * jac3_3))
            + 1 * jac0_2 * (1 * jac1_0 * (1 * jac2_1 * jac3_3) + -1 * jac1_1 * (1 * jac2_0 * jac3_3)));
